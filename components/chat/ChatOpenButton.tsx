...
export default function ChatOpenButton({ label, description }: ChatOpenButtonProps) {
  return (
    <button
      ...
      className="inline-flex min-h-11 items-center justify-center rounded-[var(--radius-pill)] border border-[color:var(--color-line)] bg-[color:var(--color-surface-strong)] px-5 text-[0.72rem] font-semibold uppercase tracking-[0.085em] text-[color:var(--color-foreground)] transition-[border-color,color,transform] duration-300 hover:-translate-y-px hover:border-[color:var(--color-brand)] hover:text-[color:var(--color-brand)]"
    >
