...
const copyByLocale: Record<Locale, FormCopy> = {
  es: {
    ...
    description:
      "Envía una consulta estructurada al correo oficial del centro si necesitas ampliar información sobre diagnóstico, tratamiento, agenda o seguimiento.",
    nameLabel: "Nombre",
    emailLabel: "Email",
    ...
    helperText: "Tiempo de respuesta habitual: dentro del horario operativo del centro.",
  ...
  ca: {
    ...
    description:
      "Envia una consulta estructurada al correu oficial del centre si necessites ampliar informacio sobre diagnosi, tractament, agenda o seguiment.",
    nameLabel: "Nom",
    emailLabel: "Email",
    ...
    fallbackText: "L'enviament directe no esta disponible ara mateix. Pots obrir el teu correu amb el missatge preomplert.",
  ...
  fr: {
    ...
    description:
      "Envoyez une demande structuree a l'email officiel du centre si vous avez besoin d'informations complementaires sur l'evaluation, le traitement, l'agenda ou le suivi.",
    nameLabel: "Nom",
    emailLabel: "Email",
    ...
    fallbackText: "L'envoi direct n'est pas disponible pour le moment. Vous pouvez ouvrir votre email pre-rempli.",
  ...
  en: {
    ...
    description:
      "Send a structured request to the centre's official email if you need more information about assessment, treatment planning, agenda or follow-up.",
    nameLabel: "Name",
    emailLabel: "Email",
    ...
    fallbackText: "Direct sending is not available right now. You can open your email with the prefilled message.",
